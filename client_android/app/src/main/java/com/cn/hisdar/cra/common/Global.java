package com.cn.hisdar.cra.common;
...
public class Global {
	...
	public static final String XML_NODE_BYTES_DATA_HEAD			= "byteDataHead";
	public static final String XML_NODE_DATA_SIZE				= "dataSize";
